...
export const BITS: DrillPart[] = [
  { id: 'bit_1', iconPath: '/equipment/bits/bit_1.png', tier: 1, mass: 10, rarity: 'Common', name: { RU: 'Ржавое жало', EN: 'Rusty Sting' }, description: { RU: 'Базовый урон 1. Потребляет 1 энергии.', EN: 'Base damage 1. Consumes 1 energy.' }, cost: { clay: 50 }, baseStats: { damage: 1, energyCost: 1 }, fxId: 'pixel_sparks_brown' },
  { id: 'bit_2', iconPath: '/equipment/bits/bit_2.png', tier: 2, mass: 17, rarity: 'Common', name: { RU: 'Стальной Крот', EN: 'Steel Mole' }, description: { RU: 'Урон 5. Потребляет 3 энергии.', EN: 'Damage 5. Consumes 3 energy.' }, cost: { clay: 200, stone: 50 }, baseStats: { damage: 5, energyCost: 3 }, fxId: 'none' },
  { id: 'bit_3', iconPath: '/equipment/bits/bit_3.png', tier: 3, mass: 23, rarity: 'Common', name: { RU: 'Зуб Мамонта', EN: 'Mammoth Tooth' }, description: { RU: 'Усиленный сплав. Урон: 12. Энергия: 5.', EN: 'Reinforced alloy. Damage: 12. Energy: 5.' }, cost: { stone: 300, copper: 100 }, baseStats: { damage: 12, energyCost: 5 }, fxId: 'none' },
  { id: 'bit_4', iconPath: '/equipment/bits/bit_4.png', tier: 4, mass: 28, rarity: 'Rare', name: { RU: 'Победитовое сверло', EN: 'Widia Drill' }, description: { RU: 'Классика индустрии. Урон: 25. Энергия: 8.', EN: 'Industrial classic. Damage: 25. Energy: 8.' }, cost: { copper: 500, iron: 200 }, baseStats: { damage: 25, energyCost: 8 }, fxId: 'blue_glint' },
  { id: 'bit_5', iconPath: '/equipment/bits/bit_5.png', tier: 5, mass: 33, rarity: 'Rare', name: { RU: 'Титановый Клык', EN: 'Titanium Fang' }, description: { RU: 'Легкий и острый. Урон: 45. Энергия: 12.', EN: 'Light and sharp. Damage: 45. Energy: 12.' }, cost: { iron: 800, silver: 300 }, baseStats: { damage: 45, energyCost: 12 }, fxId: 'blue_glint' },
  { id: 'bit_6', iconPath: '/equipment/bits/bit_6.png', tier: 6, mass: 38, rarity: 'Rare', name: { RU: 'Алмазный Конус', EN: 'Diamond Cone' }, description: { RU: 'Пробивает всё. Урон: 80. Энергия: 18.', EN: 'Bores through all. Damage: 80. Energy: 18.' }, cost: { silver: 1200, gold: 400, diamonds: 5 }, baseStats: { damage: 80, energyCost: 18 }, fxId: 'blue_glint' },
  { id: 'bit_7', iconPath: '/equipment/bits/bit_7.png', tier: 7, mass: 43, rarity: 'Epic', name: { RU: 'Вибро-бур "Сверчок"', EN: 'Vibro-drill "Cricket"' }, description: { RU: 'Ультразвуковой распад. Урон: 120. Энергия: 25.', EN: 'Ultrasound decay. Damage: 120. Energy: 25.' }, cost: { gold: 2000, titanium: 500, rubies: 10 }, blueprintId: 'blueprint_advanced_drilling', baseStats: { damage: 120, energyCost: 25 }, fxId: 'golden_aura_vfx' },
...
export const ENGINES: EnginePart[] = [
  { id: 'eng_1', iconPath: '/equipment/engines/eng_1.webp', tier: 1, mass: 80, rarity: 'Common', name: { RU: 'Ручной привод', EN: 'Manual Drive' }, description: { RU: 'Скорость 1.0. Не требует энергии.', EN: 'Speed 1.0. Requires no energy.' }, cost: { clay: 50 }, baseStats: { speed: 1.0, energyCost: 0 } },
  { id: 'eng_2', iconPath: '/equipment/engines/eng_2.webp', tier: 2, mass: 139, rarity: 'Common', name: { RU: 'Паровой котел', EN: 'Steam Boiler' }, description: { RU: 'Скорость 2.5. Потребляет 5 энергии.', EN: 'Speed 2.5. Consumes 5 energy.' }, cost: { stone: 100 }, baseStats: { speed: 2.5, energyCost: 5 } },
  { id: 'eng_3', iconPath: '/equipment/engines/eng_3.webp', tier: 3, mass: 193, rarity: 'Common', name: { RU: 'Дизель "Старый Джо"', EN: 'Diesel "Old Joe"' }, description: { RU: 'Скорость 3.0. Высокий крутящий момент. Энергия: 10.', EN: 'Speed 3.0. High torque. Energy: 10.' }, cost: { copper: 300 }, baseStats: { speed: 3.0, energyCost: 10 } },
  { id: 'eng_4', iconPath: '/equipment/engines/eng_4.webp', tier: 4, mass: 243, rarity: 'Rare', name: { RU: 'Электромотор "Искра"', EN: 'Electric Motor "Spark"' }, description: { RU: 'Скорость 3.3. Энергия: 15.', EN: 'Speed 3.3. Energy: 15.' }, cost: { iron: 600 }, baseStats: { speed: 3.3, energyCost: 15 } },
  { id: 'eng_5', iconPath: '/equipment/engines/eng_5.webp', tier: 5, mass: 290, rarity: 'Rare', name: { RU: 'Турбина "Циклон"', EN: 'Turbine "Cyclone"' }, description: { RU: 'Скорость 3.6. Энергия: 25.', EN: 'Speed 3.6. Energy: 25.' }, cost: { silver: 1000 }, baseStats: { speed: 3.6, energyCost: 25 } },
  { id: 'eng_6', iconPath: '/equipment/engines/eng_6.webp', tier: 6, mass: 335, rarity: 'Rare', name: { RU: 'Ротор "Вихрь"', EN: 'Rotor "Whirl"' }, description: { RU: 'Скорость 4.0. Энергия: 40.', EN: 'Speed 4.0. Energy: 40.' }, cost: { gold: 1500, rubies: 5 }, baseStats: { speed: 4.0, energyCost: 40 } },
  { id: 'eng_7', iconPath: '/equipment/engines/eng_7.webp', tier: 7, mass: 379, rarity: 'Epic', name: { RU: 'Магнитный драйв', EN: 'Magnetic Drive' }, description: { RU: 'Скорость 6.0. Энергия: 60.', EN: 'Speed 6.0. Energy: 60.' }, cost: { titanium: 2500, nanoSwarm: 50 }, blueprintId: 'blueprint_high_power_engines', baseStats: { speed: 6.0, energyCost: 60 } },
  { id: 'eng_8', iconPath: '/equipment/engines/eng_8.webp', tier: 8, mass: 422, rarity: 'Epic', name: { RU: 'Ионный ускоритель', EN: 'Ionic Accelerator' }, description: { RU: 'Скорость 9.0. Энергия: 80.', EN: 'Speed 9.0. Energy: 80.' }, cost: { uranium: 1000, emeralds: 20 }, blueprintId: 'blueprint_high_power_engines', baseStats: { speed: 9.0, energyCost: 80 } },
  { id: 'eng_9', iconPath: '/equipment/engines/eng_9.webp', tier: 9, mass: 464, rarity: 'Epic', name: { RU: 'Фотонный двигатель', EN: 'Photonic Engine' }, description: { RU: 'Скорость 12.0. Энергия: 100.', EN: 'Speed 12.0. Energy: 100.' }, cost: { ancientTech: 20, rubies: 30 }, blueprintId: 'blueprint_high_power_engines', baseStats: { speed: 12.0, energyCost: 100 } },
  { id: 'eng_10', iconPath: '/equipment/engines/eng_10.webp', tier: 10, mass: 505, rarity: 'Legendary', name: { RU: 'Варп-привод', EN: 'Warp Drive' }, description: { RU: 'Скорость 18.0. Энергия: 150.', EN: 'Speed 18.0. Energy: 150.' }, cost: { ancientTech: 50, rubies: 50, nanoSwarm: 200 }, blueprintId: 'blueprint_quantum_engines', baseStats: { speed: 18.0, energyCost: 150 } },
  { id: 'eng_11', iconPath: '/equipment/engines/eng_11.webp', tier: 11, mass: 545, rarity: 'Legendary', name: { RU: 'Тахионный ротор', EN: 'Tachyon Rotor' }, description: { RU: 'Скорость 25.0. Энергия: 200.', EN: 'Speed 25.0. Energy: 200.' }, cost: { ancientTech: 150, voidMatter: 100, emeralds: 50, nanoSwarm: 400 }, blueprintId: 'blueprint_quantum_engines', baseStats: { speed: 25.0, energyCost: 200 } },
  { id: 'eng_12', iconPath: '/equipment/engines/eng_12.webp', tier: 12, mass: 584, rarity: 'Legendary', name: { RU: 'Темная материя', EN: 'Dark Matter' }, description: { RU: 'Скорость 40.0. Энергия: 300.', EN: 'Speed 40.0. Energy: 300.' }, cost: { ancientTech: 400, voidMatter: 300, diamonds: 50, nanoSwarm: 800 }, blueprintId: 'blueprint_quantum_engines', baseStats: { speed: 40.0, energyCost: 300 } },
  { id: 'fus_eng_13', iconPath: '/equipment/engines/fus_eng_13.webp', tier: 13, mass: 623, rarity: 'Godly', name: { RU: 'Нулевая точка', EN: 'Zero Point' }, description: { RU: 'Скорость 60.0. Энергия: 500.', EN: 'Speed 60.0. Energy: 500.' }, cost: { ancientTech: 1000, chronoShards: 50, nanoSwarm: 2000, rubies: 200 }, blueprintId: 'blueprint_fusion_core', baseStats: { speed: 60.0, energyCost: 500 } },
  { id: 'fus_eng_14', iconPath: '/equipment/engines/fus_eng_14.webp', tier: 14, mass: 661, rarity: 'Godly', name: { RU: 'Квантовый суперпозитор', EN: 'Quantum Superpositor' }, description: { RU: 'Скорость 100.0. Энергия: 800.', EN: 'Speed 100.0. Energy: 800.' }, cost: { ancientTech: 2500, chronoShards: 200, rubies: 1000, diamonds: 500 }, blueprintId: 'blueprint_fusion_core', baseStats: { speed: 100.0, energyCost: 800 } },
  { id: 'fus_eng_15', iconPath: '/equipment/engines/fus_eng_15.webp', tier: 15, mass: 698, rarity: 'Godly', name: { RU: 'Двигатель Воли', EN: 'Engine of Will' }, description: { RU: 'Скорость 200.0. Энергия: 1500.', EN: 'Speed 200.0. Energy: 1500.' }, cost: { ancientTech: 9999, chronoShards: 1000, nanoSwarm: 5000 }, blueprintId: 'blueprint_fusion_core', baseStats: { speed: 200.0, energyCost: 1500 } }
];


export const COOLERS: CoolerPart[] = [
  { id: 'cool_1', iconPath: '/equipment/coolers/cool_1.png', tier: 1, mass: 30, rarity: 'Common', name: { RU: 'Дырявый бак', EN: 'Leaky Tank' }, description: { RU: 'Охлаждение 1. Экономит энергию.', EN: 'Cooling 1. Saves energy.' }, cost: { clay: 20 }, baseStats: { cooling: 1, energyCost: 0 } },
  { id: 'cool_2', iconPath: '/equipment/coolers/cool_2.png', tier: 2, mass: 49, rarity: 'Common', name: { RU: 'Медный радиатор', EN: 'Copper Radiator' }, description: { RU: 'Охлаждение 3. Потребляет 1 энергии.', EN: 'Cooling 3. Consumes 1 energy.' }, cost: { copper: 100 }, baseStats: { cooling: 3, energyCost: 1 } },
  { id: 'cool_3', iconPath: '/equipment/coolers/cool_3.png', tier: 3, mass: 65, rarity: 'Common', name: { RU: 'Вентилятор "Тайфун"', EN: 'Turbine "Typhoon"' }, description: { RU: 'Активный обдув. Охл: 5. Энергия: 3.', EN: 'Active cooling. Cool: 5. Energy: 3.' }, cost: { iron: 300 }, baseStats: { cooling: 5, energyCost: 3 } },
  { id: 'cool_4', iconPath: '/equipment/coolers/cool_4.png', tier: 4, mass: 79, rarity: 'Rare', name: { RU: 'Масляный контур', EN: 'Oil Circuit' }, description: { RU: 'Эффективный теплоотвод. Охл: 8. Энергия: 6.', EN: 'Efficient heat sink. Cool: 8. Energy: 6.' }, cost: { silver: 600 }, baseStats: { cooling: 8, energyCost: 6 } },
  { id: 'cool_5', iconPath: '/equipment/coolers/cool_5.png', tier: 5, mass: 93, rarity: 'Rare', name: { RU: 'Фреоновая петля', EN: 'Freon Loop' }, description: { RU: 'Заморозка фреоном. Охл: 12. Энергия: 10.', EN: 'Freon freezing. Cool: 12. Energy: 10.' }, cost: { gold: 1000, emeralds: 5 }, baseStats: { cooling: 12, energyCost: 10 } },
  { id: 'cool_6', iconPath: '/equipment/coolers/cool_6.png', tier: 6, mass: 105, rarity: 'Rare', name: { RU: 'Жидкий Азот', EN: 'Liquid Nitrogen' }, description: { RU: 'Криогенная мощь. Охл: 18. Энергия: 15.', EN: 'Cryogenic power. Cool: 18. Energy: 15.' }, cost: { titanium: 1500, emeralds: 10 }, baseStats: { cooling: 18, energyCost: 15 } },
  { id: 'cool_7', iconPath: '/equipment/coolers/cool_7.png', tier: 7, mass: 117, rarity: 'Epic', name: { RU: 'Гелиевый инжектор', EN: 'Helium Injector' }, description: { RU: 'Жидкий гелий. Охл: 25. Энергия: 20.', EN: 'Liquid helium. Cool: 25. Energy: 20.' }, cost: { uranium: 500, diamonds: 5 }, blueprintId: 'blueprint_quantum_cooling', baseStats: { cooling: 25, energyCost: 20 } },
...
export const HULLS: HullPart[] = [
  { id: 'hull_1', iconPath: '/equipment/hulls/hull_1.png', tier: 1, mass: 500, rarity: 'Common', name: { RU: 'Каркас из труб', EN: 'Pipe Frame' }, description: { RU: '1 слот. HP: 50. Груз: 5к.', EN: '1 slot. HP: 50. Cargo: 5k.' }, cost: { clay: 50 }, baseStats: { maxIntegrity: 50, slots: 1, heatCap: 100, regen: 0, cargoCapacity: 5000 } },
  { id: 'hull_2', iconPath: '/equipment/hulls/hull_2.png', tier: 2, mass: 917, rarity: 'Common', name: { RU: 'Грузовой бокс', EN: 'Cargo Box' }, description: { RU: '1 слот. HP: 150. Груз: 6к.', EN: '1 slot. HP: 150. Cargo: 6k.' }, cost: { stone: 200 }, baseStats: { maxIntegrity: 150, slots: 1, heatCap: 150, regen: 0, cargoCapacity: 6000 } },
  { id: 'hull_3', iconPath: '/equipment/hulls/hull_3.png', tier: 3, mass: 1308, rarity: 'Common', name: { RU: 'Сплав "Шахтер"', EN: 'Alloy "Miner"' }, description: { RU: '2 слота. HP: 200. Реген.', EN: '2 slots. HP: 200. Regen.' }, cost: { copper: 500 }, baseStats: { maxIntegrity: 200, slots: 2, heatCap: 200, regen: 0.1, cargoCapacity: 7500 } },
  { id: 'hull_4', iconPath: '/equipment/hulls/hull_4.png', tier: 4, mass: 1682, rarity: 'Rare', name: { RU: 'Укрепленный кокон', EN: 'Reinforced Cocoon' }, description: { RU: '2 слота. HP: 400. Крепкий.', EN: '2 slots. HP: 400. Tough.' }, cost: { iron: 1000 }, baseStats: { maxIntegrity: 400, slots: 2, heatCap: 250, regen: 0.2, cargoCapacity: 10000 } },
  { id: 'hull_5', iconPath: '/equipment/hulls/hull_5.png', tier: 5, mass: 2044, rarity: 'Rare', name: { RU: 'Рама "Авангард"', EN: 'Frame "Vanguard"' }, description: { RU: '3 слота. HP: 500. Реген: 0.5', EN: '3 slots. HP: 500. Regen: 0.5' }, cost: { silver: 1500 }, baseStats: { maxIntegrity: 500, slots: 3, heatCap: 300, regen: 0.5, cargoCapacity: 15000 } },
  { id: 'hull_6', iconPath: '/equipment/hulls/hull_6.png', tier: 6, mass: 2398, rarity: 'Rare', name: { RU: 'Корпус "Бункер"', EN: 'Hull "Bunker"' }, description: { RU: '3 слота. HP: 1000. Надежный.', EN: '3 slots. HP: 1000. Reliable.' }, cost: { gold: 2500, emeralds: 5 }, baseStats: { maxIntegrity: 1000, slots: 3, heatCap: 400, regen: 1, cargoCapacity: 25000 } },
  { id: 'hull_7', iconPath: '/equipment/hulls/hull_7.png', tier: 7, mass: 2744, rarity: 'Epic', name: { RU: 'Штурмовой дек', EN: 'Assault Deck' }, description: { RU: '4 слота. HP: 1200. Реген: 2.', EN: '4 slots. HP: 1200. Regen: 2.' }, cost: { titanium: 4000, emeralds: 20 }, blueprintId: 'blueprint_titanium_hull', baseStats: { maxIntegrity: 1200, slots: 4, heatCap: 350, regen: 2, cargoCapacity: 40000 } },
  { id: 'hull_8', iconPath: '/equipment/hulls/hull_8.png', tier: 8, mass: 3084, rarity: 'Epic', name: { RU: 'Оболочка "Стелс"', EN: 'Hull "Stealth"' }, description: { RU: '4 слота. HP: 1400. Теплоемкость!', EN: '4 slots. HP: 1400. Heat Cap!' }, cost: { uranium: 1500, nanoSwarm: 50 }, blueprintId: 'blueprint_titanium_hull', baseStats: { maxIntegrity: 1400, slots: 4, heatCap: 500, regen: 3, cargoCapacity: 70000 } },
...
export const LOGIC_CORES: LogicPart[] = [
  { id: 'cpu_1', iconPath: '/equipment/cores/cpu_1.png', tier: 1, mass: 5, rarity: 'Common', name: { RU: 'Калькулятор', EN: 'Calculator' }, description: { RU: 'Крит 1%. Энергия: 1.', EN: 'Crit 1%. Energy: 1.' }, cost: { clay: 50 }, baseStats: { critChance: 1, energyCost: 1, luck: 0, predictionTime: 0 } },
  { id: 'cpu_2', iconPath: '/equipment/cores/cpu_2.png', tier: 2, mass: 8, rarity: 'Common', name: { RU: 'Блок "Сигнал"', EN: 'Unit "Signal"' }, description: { RU: 'Ловит эхо породы.', EN: 'Catches rock echoes.' }, cost: { copper: 150 }, baseStats: { critChance: 3, energyCost: 3, luck: 0, predictionTime: 0 } },
  { id: 'cpu_3', iconPath: '/equipment/cores/cpu_3.png', tier: 3, mass: 10, rarity: 'Common', name: { RU: 'Логика "Скан"', EN: 'Logic "Scan"' }, description: { RU: 'Скан породы. Крит: 4%. Удача: 1. Энергия: 5.', EN: 'Rock scanning. Crit: 4%. Luck: 1. Energy: 5.' }, cost: { iron: 300 }, baseStats: { critChance: 4, energyCost: 5, luck: 1, predictionTime: 0 } },
  { id: 'cpu_4', iconPath: '/equipment/cores/cpu_4.png', tier: 4, mass: 11, rarity: 'Rare', name: { RU: 'Процессор "Вектор"', EN: 'Processor "Vector"' }, description: { RU: 'Векторный анализ. Крит: 5%. Удача: 2. Энергия: 8.', EN: 'Vector analysis. Crit: 5%. Luck: 2. Energy: 8.' }, cost: { silver: 600 }, baseStats: { critChance: 5, energyCost: 8, luck: 2, predictionTime: 0 } },
  { id: 'cpu_5', iconPath: '/equipment/cores/cpu_5.png', tier: 5, mass: 13, rarity: 'Rare', name: { RU: 'ИИ "Геолог"', EN: 'AI "Geologist"' }, description: { RU: 'Подсветка жил. Крит: 7%. Удача: 5. Энергия: 12.', EN: 'Vein highlighting. Crit: 7%. Luck: 5. Energy: 12.' }, cost: { gold: 1000, emeralds: 5 }, baseStats: { critChance: 7, energyCost: 12, luck: 5, predictionTime: 0 } },
  { id: 'cpu_6', iconPath: '/equipment/cores/cpu_6.png', tier: 6, mass: 15, rarity: 'Rare', name: { RU: 'Матрица "Поиск"', EN: 'Matrix "Search"' }, description: { RU: 'Поиск сокровищ. Крит: 10%. Удача: 8. Энергия: 18.', EN: 'Treasure search. Crit: 10%. Luck: 8. Energy: 18.' }, cost: { titanium: 1500, emeralds: 10 }, baseStats: { critChance: 10, energyCost: 18, luck: 8, predictionTime: 0 } },
  { id: 'cpu_7', iconPath: '/equipment/cores/cpu_7.png', tier: 7, mass: 16, rarity: 'Epic', name: { RU: 'Ядро "Ритм"', EN: 'Core "Rhythm"' }, description: { RU: 'Синхро-импульс. Крит: 12%. Предсказание: 2с. Энергия: 25.', EN: 'Sync-pulse. Crit: 12%. Prediction: 2s. Energy: 25.' }, cost: { uranium: 800, nanoSwarm: 20 }, baseStats: { critChance: 12, energyCost: 25, luck: 10, predictionTime: 2 } },
...
export const CONTROL_UNITS: ControlPart[] = [
  ...
  { id: 'ctrl_1', iconPath: '/equipment/units/ctrl_1.png', tier: 1, mass: 8, rarity: 'Common', name: { RU: 'Старая кнопка', EN: 'Old Button' }, description: { RU: 'x1.0', EN: 'x1.0' }, cost: { clay: 10 }, baseStats: { clickMultiplier: 1.0, energyCost: 0, ventSpeed: 1.0 } },
...
export const GEARBOXES: GearboxPart[] = [
  { id: 'gear_1', iconPath: '/equipment/gears/gear_1.png', tier: 1, mass: 40, rarity: 'Common', name: { RU: 'Деревянные шестерни', EN: 'Wooden Gears' }, description: { RU: 'Крутящий момент 1. Энергия: 0.', EN: 'Torque 1. Energy: 0.' }, cost: { clay: 50 }, baseStats: { torque: 1.0, energyCost: 0 } },
  { id: 'gear_2', iconPath: '/equipment/gears/gear_2.png', tier: 2, mass: 65, rarity: 'Common', name: { RU: 'Чугунная муфта', EN: 'Cast Iron Clutch' }, description: { RU: 'Крутящий момент 2. Энергия: 2.', EN: 'Torque 2. Energy: 2.' }, cost: { copper: 200 }, baseStats: { torque: 2.0, energyCost: 2 } },
  { id: 'gear_3', iconPath: '/equipment/gears/gear_3.png', tier: 3, mass: 88, rarity: 'Common', name: { RU: 'Стальной редуктор', EN: 'Steel Reducer' }, description: { RU: 'Крутящий момент 3.5. Энергия: 5.', EN: 'Torque 3.5. Energy: 5.' }, cost: { iron: 500 }, baseStats: { torque: 3.5, energyCost: 5 } },
  { id: 'gear_4', iconPath: '/equipment/gears/gear_4.png', tier: 4, mass: 109, rarity: 'Rare', name: { RU: 'Зубчатый вал', EN: 'Toothed Shaft' }, description: { RU: 'Крутящий момент 5. Энергия: 8.', EN: 'Torque 5. Energy: 8.' }, cost: { silver: 800 }, baseStats: { torque: 5.0, energyCost: 8 } },
  { id: 'gear_5', iconPath: '/equipment/gears/gear_5.png', tier: 5, mass: 131, rarity: 'Rare', name: { RU: 'Планетарная передача', EN: 'Planetary Gear' }, description: { RU: 'Крутящий момент 7.5. Энергия: 12.', EN: 'Torque 7.5. Energy: 12.' }, cost: { gold: 1500, emeralds: 5 }, baseStats: { torque: 7.5, energyCost: 12 } },
  { id: 'gear_6', iconPath: '/equipment/gears/gear_6.png', tier: 6, mass: 151, rarity: 'Rare', name: { RU: 'Гидро-трансмиссия', EN: 'Hydro-transmission' }, description: { RU: 'Крутящий момент 10. Энергия: 18.', EN: 'Torque 10. Energy: 18.' }, cost: { titanium: 2500, rubies: 10 }, baseStats: { torque: 10.0, energyCost: 18 } },
  { id: 'gear_7', iconPath: '/equipment/gears/gear_7.png', tier: 7, mass: 171, rarity: 'Epic', name: { RU: 'Магнитная муфта', EN: 'Magnetic Clutch' }, description: { RU: 'Крутящий момент 15. Энергия: 25.', EN: 'Torque 15. Energy: 25.' }, cost: { uranium: 1000, diamonds: 10 }, blueprintId: 'blueprint_high_performance_transmission', baseStats: { torque: 15.0, energyCost: 25 } },
...
export const POWER_CORES: PowerCorePart[] = [
  { id: 'pwr_1', iconPath: '/equipment/power/pwr_1.png', tier: 1, mass: 100, rarity: 'Common', name: { RU: 'Батарейка АА', EN: 'AA Battery' }, description: { RU: 'Выход: 10 ед. энергии.', EN: 'Output: 10 energy units.' }, cost: { clay: 50 }, baseStats: { energyOutput: 10, droneEfficiency: 1.0 } },
  { id: 'pwr_2', iconPath: '/equipment/power/pwr_2.png', tier: 2, mass: 180, rarity: 'Common', name: { RU: 'Свинцовый АКБ', EN: 'Lead Battery' }, description: { RU: '25 ед.', EN: '25 units.' }, cost: { copper: 150 }, baseStats: { energyOutput: 25, droneEfficiency: 1.05 } },
  { id: 'pwr_3', iconPath: '/equipment/power/pwr_3.png', tier: 3, mass: 254, rarity: 'Common', name: { RU: 'Бензогенератор', EN: 'Gasoline Generator' }, description: { RU: '50 ед.', EN: '50 units.' }, cost: { iron: 300 }, baseStats: { energyOutput: 50, droneEfficiency: 1.1 } },
  { id: 'pwr_4', iconPath: '/equipment/power/pwr_4.png', tier: 4, mass: 325, rarity: 'Rare', name: { RU: 'Солнечная панель', EN: 'Solar Panel' }, description: { RU: '80 ед.', EN: '80 units.' }, cost: { silver: 600 }, baseStats: { energyOutput: 80, droneEfficiency: 1.2 } },
  { id: 'pwr_5', iconPath: '/equipment/power/pwr_5.png', tier: 5, mass: 393, rarity: 'Rare', name: { RU: 'Изотопный элемент', EN: 'Isotope Element' }, description: { RU: '120 ед.', EN: '120 units.' }, cost: { gold: 1000 }, baseStats: { energyOutput: 120, droneEfficiency: 1.3 } },
  { id: 'pwr_6', iconPath: '/equipment/power/pwr_6.png', tier: 6, mass: 459, rarity: 'Rare', name: { RU: 'Ядерная ячейка', EN: 'Nuclear Cell' }, description: { RU: '180 ед.', EN: '180 units.' }, cost: { titanium: 1500, rubies: 5 }, baseStats: { energyOutput: 180, droneEfficiency: 1.5 } },
  { id: 'pwr_7', iconPath: '/equipment/power/pwr_7.png', tier: 7, mass: 523, rarity: 'Epic', name: { RU: 'Термоядерный узел', EN: 'Thermonuclear Node' }, description: { RU: '300 ед.', EN: '300 units.' }, cost: { uranium: 1000, rubies: 15 }, baseStats: { energyOutput: 300, droneEfficiency: 1.8 } },
...
export const SHIELD_GENERATORS: ShieldPart[] = [
  { id: 'shd_1', iconPath: '/equipment/shields/shd_1.png', tier: 1, mass: 20, rarity: 'Common', name: { RU: 'Искрящий виток', EN: 'Sparking Coil' }, description: { RU: 'Щит: 50. Эфф: 5%. Энергия: 1.', EN: 'Shield: 50. Eff: 5%. Energy: 1.' }, cost: { clay: 30 }, baseStats: { maxShield: 50, efficiency: 0.05, rechargeMult: 1.0, energyCost: 1 } },
  { id: 'shd_2', iconPath: '/equipment/shields/shd_2.png', tier: 2, mass: 35, rarity: 'Common', name: { RU: 'Медная сетка', EN: 'Copper Mesh' }, description: { RU: 'Щит: 100. Эфф: 10%. Энергия: 3.', EN: 'Shield: 100. Eff: 10%. Energy: 3.' }, cost: { copper: 100 }, baseStats: { maxShield: 100, efficiency: 0.10, rechargeMult: 1.2, energyCost: 3 } },
  { id: 'shd_3', iconPath: '/equipment/shields/shd_3.png', tier: 3, mass: 55, rarity: 'Common', name: { RU: 'Стальной купол', EN: 'Steel Dome' }, description: { RU: 'Щит: 150. Эфф: 15%. Энергия: 6.', EN: 'Shield: 150. Eff: 15%. Energy: 6.' }, cost: { iron: 300 }, baseStats: { maxShield: 150, efficiency: 0.15, rechargeMult: 1.5, energyCost: 6 } },
  { id: 'shd_4', iconPath: '/equipment/shields/shd_4.png', tier: 4, mass: 80, rarity: 'Rare', name: { RU: 'Кварцевый барьер', EN: 'Quartz Barrier' }, description: { RU: 'Щит: 200. Эфф: 20%. Энергия: 10.', EN: 'Shield: 200. Eff: 20%. Energy: 10.' }, cost: { silver: 600 }, baseStats: { maxShield: 200, efficiency: 0.20, rechargeMult: 2.0, energyCost: 10 } },
  { id: 'shd_5', iconPath: '/equipment/shields/shd_5.png', tier: 5, mass: 110, rarity: 'Rare', name: { RU: 'Плазменный зонт', EN: 'Plasma Umbrella' }, description: { RU: 'Щит: 250. Эфф: 25%. Энергия: 15.', EN: 'Shield: 250. Eff: 25%. Energy: 15.' }, cost: { gold: 1200 }, baseStats: { maxShield: 250, efficiency: 0.25, rechargeMult: 2.5, energyCost: 15 } },
  { id: 'shd_6', iconPath: '/equipment/shields/shd_6.png', tier: 6, mass: 145, rarity: 'Rare', name: { RU: 'Ионный кокон', EN: 'Ionic Cocoon' }, description: { RU: 'Щит: 350. Эфф: 30%. Энергия: 22.', EN: 'Shield: 350. Eff: 30%. Energy: 22.' }, cost: { diamonds: 10, titanium: 1500 }, baseStats: { maxShield: 350, efficiency: 0.30, rechargeMult: 3.0, energyCost: 22 } },
  { id: 'shd_7', iconPath: '/equipment/shields/shd_7.png', tier: 7, mass: 185, rarity: 'Epic', name: { RU: 'Грави-призма', EN: 'Gravi-Prism' }, description: { RU: 'Щит: 500. Эфф: 35%. Энергия: 30.', EN: 'Shield: 500. Eff: 35%. Energy: 30.' }, cost: { titanium: 3000, rubies: 15 }, blueprintId: 'blueprint_shield_tech', baseStats: { maxShield: 500, efficiency: 0.35, rechargeMult: 4.0, energyCost: 30 } },
...
export const FUSION_RECIPES: MergeRecipe[] = [
  ...
  // === SHIELD ===
  {
    ...
    condition: { type: 'NO_DAMAGE', target: 200, description: { RU: 'Слияние при 200% щита (Перегрузка)', EN: 'Fusion at 200% Shield (Overcharge)' } },
...
export const DRONES: DroneDefinition[] = [
  ...
  },
  {
    ...
    description: { RU: 'Требуется: Древние технологии + Алмаз (бур).', EN: 'Requires: Ancient Tech + Diamonds (drill).' },
