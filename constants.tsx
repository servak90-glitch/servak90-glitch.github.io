...
export const ENGINES: EnginePart[] = [
  { id: 'eng_1', iconPath: '/equipment/engines/eng_1.png', tier: 1, mass: 80, rarity: 'Common', name: { RU: 'Ручной привод', EN: 'Manual Drive' }, description: { RU: 'Скорость 1.0. Не требует энергии.', EN: 'Speed 1.0. Requires no energy.' }, cost: { clay: 50 }, baseStats: { speed: 1.0, energyCost: 0 } },
  { id: 'eng_2', iconPath: '/equipment/engines/eng_2.png', tier: 2, mass: 139, rarity: 'Common', name: { RU: 'Паровой котел', EN: 'Steam Boiler' }, description: { RU: 'Скорость 2.5. Потребляет 5 энергии.', EN: 'Speed 2.5. Consumes 5 energy.' }, cost: { stone: 100 }, baseStats: { speed: 2.5, energyCost: 5 } },
  { id: 'eng_3', iconPath: '/equipment/engines/eng_3.png', tier: 3, mass: 193, rarity: 'Common', name: { RU: 'Дизель "Старый Джо"', EN: 'Diesel "Old Joe"' }, description: { RU: 'Скорость 3.0. Высокий крутящий момент. Энергия: 10.', EN: 'Speed 3.0. High torque. Energy: 10.' }, cost: { copper: 300 }, baseStats: { speed: 3.0, energyCost: 10 } },
  { id: 'eng_4', iconPath: '/equipment/engines/eng_4.png', tier: 4, mass: 243, rarity: 'Rare', name: { RU: 'Электромотор "Искра"', EN: 'Electric Motor "Spark"' }, description: { RU: 'Скорость 3.3. Энергия: 15.', EN: 'Speed 3.3. Energy: 15.' }, cost: { iron: 600 }, baseStats: { speed: 3.3, energyCost: 15 } },
  { id: 'eng_5', iconPath: '/equipment/engines/eng_5.png', tier: 5, mass: 290, rarity: 'Rare', name: { RU: 'Турбина "Циклон"', EN: 'Turbine "Cyclone"' }, description: { RU: 'Скорость 3.6. Энергия: 25.', EN: 'Speed 3.6. Energy: 25.' }, cost: { silver: 1000 }, baseStats: { speed: 3.6, energyCost: 25 } },
  { id: 'eng_6', iconPath: '/equipment/engines/eng_6.png', tier: 6, mass: 335, rarity: 'Rare', name: { RU: 'Ротор "Вихрь"', EN: 'Rotor "Whirl"' }, description: { RU: 'Скорость 4.0. Энергия: 40.', EN: 'Speed 4.0. Energy: 40.' }, cost: { gold: 1500, rubies: 5 }, baseStats: { speed: 4.0, energyCost: 40 } },
  { id: 'eng_7', iconPath: '/equipment/engines/eng_7.png', tier: 7, mass: 379, rarity: 'Epic', name: { RU: 'Магнитный драйв', EN: 'Magnetic Drive' }, description: { RU: 'Скорость 6.0. Энергия: 60.', EN: 'Speed 6.0. Energy: 60.' }, cost: { titanium: 2500, nanoSwarm: 50 }, blueprintId: 'blueprint_high_power_engines', baseStats: { speed: 6.0, energyCost: 60 } },
