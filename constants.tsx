...
export const ENGINES: EnginePart[] = [
  ...
  { id: 'eng_3', iconPath: '/equipment/engines/eng_3.png', tier: 3, mass: 193, rarity: 'Common', name: { RU: 'Дизель "Старый Джо"', EN: 'Diesel "Old Joe"' }, description: { RU: 'Скорость 1.0. Высокий крутящий момент. Энергия: 10.', EN: 'Speed 1.0. High torque. Energy: 10.' }, cost: { copper: 300 }, baseStats: { speed: 1.0, energyCost: 10 } },
  { id: 'eng_4', iconPath: '/equipment/engines/eng_4.png', tier: 4, mass: 243, rarity: 'Rare', name: { RU: 'Электромотор "Искра"', EN: 'Electric Motor "Spark"' }, description: { RU: 'Скорость 1.5. Энергия: 15.', EN: 'Speed 1.5. Energy: 15.' }, cost: { iron: 600 }, baseStats: { speed: 1.5, energyCost: 15 } },
  { id: 'eng_5', iconPath: '/equipment/engines/eng_5.png', tier: 5, mass: 290, rarity: 'Rare', name: { RU: 'Турбина "Циклон"', EN: 'Turbine "Cyclone"' }, description: { RU: 'Скорость 2.5. Энергия: 25.', EN: 'Speed 2.5. Energy: 25.' }, cost: { silver: 1000 }, baseStats: { speed: 2.5, energyCost: 25 } },
...
export const HULLS: HullPart[] = [
  ...
  { id: 'hull_7', iconPath: '/equipment/hulls/hull_7.png', tier: 7, mass: 2744, rarity: 'Epic', name: { RU: 'Штурмовой дек', EN: 'Assault Deck' }, description: { RU: '4 слота. HP: 800. Реген: 2.', EN: '4 slots. HP: 800. Regen: 2.' }, cost: { titanium: 4000, emeralds: 20 }, blueprintId: 'blueprint_titanium_hull', baseStats: { maxIntegrity: 800, slots: 4, heatCap: 350, regen: 2, cargoCapacity: 40000 } },
