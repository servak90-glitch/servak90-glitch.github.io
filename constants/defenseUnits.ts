...
export const DEFENSE_UNITS: Record<DefenseUnitType, DefenseUnitDef> = {
    infantry: {
        ...
        cost: { [ResourceType.SCRAP]: 100, [ResourceType.COAL]: 50 },
        buildTime: 10000,
        defensePower: 5
    },
    drone: {
        ...
        cost: { [ResourceType.TITANIUM]: 150, [ResourceType.ANCIENT_TECH]: 10 },
        buildTime: 30000,
        defensePower: 15
    },
    turret: {
        ...
        cost: { [ResourceType.IRON]: 500, [ResourceType.SILVER]: 100, [ResourceType.GOLD]: 50 },
        buildTime: 60000,
        defensePower: 50
    },
    shield_gen: {
        ...
        cost: { [ResourceType.URANIUM]: 50, [ResourceType.ANCIENT_TECH]: 25 },
        buildTime: 120000,
        defensePower: 30
    }
};
